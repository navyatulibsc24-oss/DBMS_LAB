...
SELECT o.order_id, o.product_name, o.order_date FROM Orders o
INNER JOIN Customers c ON o.customer_id = c.customer_id WHERE c.city = 'Bangalore';
...
SELECT c.customer_id, c.customer_name, c.city, o.order_id, o.product_name, o.order_date FROM Customers c
...
SELECT o.order_id, o.product_name, o.order_date, c.customer_id, c.customer_name, c.city FROM Orders o
...
LEFT OUTER JOIN Orders o ON c.customer_id = o.customer_id
UNION
SELECT c.customer_id, c.customer_name, c.city, o.order_id, o.product_name, o.order_date FROM Orders o
RIGHT OUTER JOIN Customers c ON o.customer_id = c.customer_id;
...
SELECT o.order_id, o.product_name, o.order_date, c.customer_name, c.city FROM Orders o 
